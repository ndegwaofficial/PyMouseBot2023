...
|_|     \__  |  |_||_||_|\___/ \____(___/ \____)  |______/ \___/ \___)
       (____/                                                         
                ...
                +-+-+-+-+-+-+-+ +-+-+ +-+-+-+-+-+-+-+-+-++-+-+-+-+
                |P|o|w|e|r|e|d| |b|y| |N|d|e|g|w|a|O|f|f|i|c|i|a|l
                +-+-+-+-+-+-+-+ +-+-+ +-+-+-+-+-+-+-+-+-++-+-+-+-+
                
    https://github.com/ndegwaofficial 
``` -->
<p align="center">
...
```bash
git clone https://github.com/ndegwaofficial/PyMouseBot2023.git && cd PyMouseBot
```
